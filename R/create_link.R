...
#' @param open_ext Whether the link should be opened in an external browser when
...
create_link <- function(
  ...
  cli::cli_alert_success("Link '{document_name}' has been created.")
}
